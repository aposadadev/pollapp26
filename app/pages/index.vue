...
<template>
  <div class="relative font-sans">
    ...
    <div
      class="relative w-full h-[300px] rounded-b-[48px] overflow-hidden bg-gradient-to-b from-primary-900 to-primary-700 dark:from-primary-950 dark:to-primary-900 px-6 pt-6"
    >
